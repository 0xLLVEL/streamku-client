...
import { updateTvShowAction } from '@/app/actions/admin-content';
...
export function TvShowEditForm({ tvShow }: { tvShow: any }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const res = await updateTvShowAction(tvShow.id, formData);

    if (res.success) {
      setMessage({ text: 'TV Show updated successfully!', type: 'success' });
    ...
    <form onSubmit={handleSubmit} className="flex flex-col h-[100vh] -m-6 md:-m-8">
      ...
      <div className="flex items-center justify-between px-8 py-5 border-b border-white/10 bg-[#050505]/80 backdrop-blur-md z-10 sticky top-0">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-medium text-white tracking-tight">Edit &ldquo;{tvShow.name}&rdquo;</h1>
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-transparent">
            ...
            <div className="max-w-4xl space-y-8 animate-in fade-in duration-300">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 pt-2">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" name="is_featured" defaultChecked={tvShow.is_featured} className="sr-only peer" />
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="number" name="number_of_seasons" defaultValue={tvShow.number_of_seasons} readOnly className="w-full bg-transparent border border-white/10 rounded px-4 py-2.5 text-white/50 text-sm focus:outline-none cursor-not-allowed" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="number" step="0.1" name="popularity" defaultValue={tvShow.popularity} className="w-full bg-transparent border border-white/10 rounded px-4 py-2.5 text-white text-sm focus:border-[#ff4b4b] focus:outline-none focus:bg-[#25252d] transition-colors" />
                </div>
                <div>
          ...
          {activeTab === 'seasons' && (
             <div className="max-w-6xl animate-in fade-in duration-300">
              <h2 className="text-xl font-bold text-white mb-6">Seasons ({tvShow.seasons?.length || 0})</h2>
          ...
          {activeTab === 'images' && (
            <div className="max-w-6xl space-y-12 animate-in fade-in duration-300">
              <div>
                <h2 className="text-xl font-bold text-white mb-6">Backdrops ({tvShow.images?.backdrops?.length || (tvShow.backdrop_path ? 1 : 0)})</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-white mb-6">Posters ({tvShow.images?.posters?.length || (tvShow.poster_path ? 1 : 0)})</h2>
          ...
          {activeTab === 'videos' && (
            <div className="max-w-6xl animate-in fade-in duration-300">
              <h2 className="text-xl font-bold text-white mb-6">Videos ({tvShow.videos?.length || 0})</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {activeTab === 'cast' && (
             <div className="max-w-6xl animate-in fade-in duration-300">
              <h2 className="text-xl font-bold text-white mb-6">Cast ({tvShow.cast?.length || 0})</h2>
