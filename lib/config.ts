...
export const STREAM_PROVIDERS = {
  VidKing: { label: 'VidKing', base: 'https://www.vidking.net', movie: (k: string) => `/embed/movie/${k}`, tv: (k: string, s: number | string, e: number | string) => `/embed/tv/${k}/${s}/${e}` },
  VixSrc: { label: 'VixSrc', base: 'https://vixsrc.to', movie: (k: string) => `/embed/movie/${k}`, tv: (k: string, s: number | string, e: number | string) => `/embed/tv/${k}/${s}/${e}` },
  VidSrcCc: { label: 'VidSrc.cc', base: 'https://vidsrc.cc', movie: (k: string) => `/embed/movie/${k}`, tv: (k: string, s: number | string, e: number | string) => `/embed/tv/${k}/${s}/${e}` },
  VidSrcMe: { label: 'VidSrc.me', base: 'https://vidsrc.me', movie: (k: string) => `/embed/movie/${k}`, tv: (k: string, s: number | string, e: number | string) => `/embed/tv/${k}/${s}/${e}` },
  ...
  EmbedSu: { label: 'EmbedSu', base: 'https://embed.su', movie: (k: string) => `/embed/movie/${k}`, tv: (k: string, s: number | string, e: number | string) => `/embed/tv/${k}/${s}/${e}` },
  AutoEmbed: { label: 'AutoEmbed', base: 'https://autoembed.cc', movie: (k: string) => `/embed/movie/${k}`, tv: (k: string, s: number | string, e: number | string) => `/embed/tv/${k}/${s}/${e}` },
