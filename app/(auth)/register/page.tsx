      ...
      <div className="relative z-10 w-full max-w-7xl px-8 py-12 flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-24">
        ...
        <div className="flex-1 text-left hidden md:block">
          ...
          <p className="text-xl text-white/70 font-medium max-w-lg mb-10 leading-relaxed drop-shadow-md">
            Create an account to unlock thousands of movies and TV shows. No credit card required.
          </p>
        ...
        {/* Right Side: Register Card (Liquid Glass) */}
        <div className="w-full max-w-[480px] p-10 liquid-glass rounded-[2rem] shadow-[0_30px_60px_rgba(0,0,0,0.8)] border border-white/10 my-8">
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-white mb-2">Create an account</h2>
            <p className="text-white/50 text-sm font-medium">Join Streamku and start watching today.</p>
          </div>
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div>
              <label className="block text-[11px] font-bold text-white/50 mb-2 uppercase tracking-widest">Email Address</label>
              <input 
                type="email" 
                name="email" 
                required 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-[11px] font-bold text-white/50 mb-2 uppercase tracking-widest">Password</label>
                <div className="relative">
                  <input 
                    type={showPassword ? "text" : "password"} 
                    name="password" 
                    required 
                    className="w-full px-5 py-3.5 bg-black/40 border border-white/5 focus:bg-black/60 focus:border-white/20 backdrop-blur-md outline-none text-white rounded-xl transition-all shadow-inner pr-10"
                  />
                  <button 
                    type="button" 
              ...
              <div>
                <label className="block text-[11px] font-bold text-white/50 mb-2 uppercase tracking-widest">Confirm</label>
                <div className="relative">
                  <input 
                    type={showPassword ? "text" : "password"} 
            ...
            <button 
              type="submit" 
              disabled={isPending}
              className="w-full py-4 mt-4 bg-red-600 hover:bg-red-500 text-white font-bold rounded-xl transition-all shadow-[0_0_20px_rgba(220,38,38,0.4)] disabled:opacity-50"
            >
