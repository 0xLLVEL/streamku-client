              ...
              <div key={index} className="snap-start flex-shrink-0 w-36 group">
                <div className="aspect-[2/3] rounded-2xl overflow-hidden liquid-glass mb-3">
                  {actor.profile_path ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-white/5 text-white/30 text-sm">No Image</div>
                  )}
                </div>
                <h3 className="text-white font-bold text-sm truncate drop-shadow-sm">{actor.name}</h3>
